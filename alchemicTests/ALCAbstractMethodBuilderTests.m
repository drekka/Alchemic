...
@interface DummyBuilder : ALCAbstractMethodBuilder
@end

@implementation DummyBuilder
...
-(void) testConfigureWithMacroProcessor {
    ...
    ignoreSelectorWarnings(
                           ALCAbstractMethodBuilder *methodBuilder = [[DummyBuilder alloc] initWithParentClassBuilder:_parentBuilder
    ...
    [methodBuilder resolveWithPostProcessors:[NSSet set] dependencyStack:[NSMutableArray array]];
