...
/**
 ...
 @param objectInjector <#injector description#>
 */
...
/**
 Using the registered factories, instanciate an object based on the passed class info.
 
 @param classInfo the class info that describes the desired object.
